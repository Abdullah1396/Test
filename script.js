...
question:"أي رابط ظهر في ذهنك أولاً؟",
answers:[{text:"الحقيبة + الفانوس", type:"explorer"},
...
if(winner==="builder"){
title="🔧 النمط البنائي";
desc="تركز على كيفية عمل الأشياء وربطها عملياً.";

decisionText="تميل لاتخاذ قرارات عملية ومباشرة.";
...
desc="تبحث دائماً عما وراء الصورة الظاهرة.";

decisionText="تميل لتجربة الخيارات قبل الالتزام بقرار نهائي.";
...
<h3>🧠 كيف تتخذ قراراتك؟</h3>
<p>${decisionText}</p>

<h3>📚 كيف تتعلم بشكل أفضل؟</h3>
<p>${learningText}</p>
